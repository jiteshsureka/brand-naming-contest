    ...
    <section className="section">
      <div className="container-narrow">
        <div className="panel p-10 sm:p-14 text-center relative overflow-hidden">
          ...
          />
          <h2 className="text-3xl sm:text-4xl font-semibold">Make Your Mark. Win a Trip.</h2>
          <div className="mt-8 flex items-center justify-center gap-4 text-xl sm:text-2xl font-medium flex-wrap">
            <span>Dhaka</span>
            <span className="text-accent">&#9992;</span>
            <span>Cox&rsquo;s Bazar</span>
            <span className="text-accent">&#9992;</span>
            <span>Dhaka</span>
          </div>
